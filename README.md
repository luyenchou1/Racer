...
| TURBO | Burns the turbo meter for a burst of speed; the meter refills over time and faster while slipstreaming |
| II / ♫ | Pause / mute |

**Keyboard** (desktop testing)

Arrows or WASD to steer/gas/brake, Shift or Z for turbo, Enter/Space to
start, P or Esc to pause, M to mute, C to toggle the CRT scanline overlay.
